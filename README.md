...
> В том числе [GeoHide DNS](https://t.me/Inter_net_Helper/6) - созданный автором данной инструкции в частном порядке (поддержать аренду сервера можно через [CloudTips](https://pay.cloudtips.ru/p/ddeac224) или [Юмани](https://yoomoney.ru/to/41001945296522)).
